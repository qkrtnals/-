...
|step| 0 |	1 |2|3|
|-|--|--|--|--|
|loss|	107025.40429826111|	87.63312642504651|	50.75424835545703| 13.82399979089048|
|accuracy|0.97|0.96| 0.96| 0.97|
초기 단계에서의 loss는 107025.40429826111으로 매우 높은 값을 나타내지만 훈련이 진행될 수록 loss가 감소하고 있다. 학습 데이터의 긍부정 예측 정확도는 0.97이 나왔다. 즉 모델이 학습 데이터의 긍정과 부정을 분류하는 것을 올바르게 학습되었다는 것을 확인할 수 있다.
